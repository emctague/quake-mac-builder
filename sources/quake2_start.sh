...
export VK_ICD_FILENAMES="$VULKAN_SDK"/macOS/share/vulkan/icd/MoltenVK_icd.json
export VK_LAYER_PATH="$VULKAN_SDK"/vulkansdk/macOS/share/vulkan/explicit_layer
